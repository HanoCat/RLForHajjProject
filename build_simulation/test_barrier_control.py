...
from utils.barrier_control import get_movable_barriers

with open("../json/processed_environment.json", "r", encoding="utf-8") as f:
    env = json.load(f)
...
from utils.barrier_control import apply_barrier_actions, rotate_barriers
